...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            // 'images.*' => 'nullable|image|max:10240' // Disabled to allow JSON payload without files to pass
        ]);
        ...
        try {
            $order = Order::create([
                ...
                'created_by' => Auth::id() ?? 2, // Use Authenticated user or fallback to Admin (ID 2)
